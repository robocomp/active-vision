...
/** \mainpage RoboComp::VisualRoutines
 *
 * \section intro_sec Introduction
 *
 * The VisualRoutines component...
 *
 ...
 *
 * Just: "${PATH_TO_BINARY}/VisualRoutines --Ice.Config=${PATH_TO_CONFIG_FILE}"
 *
...
class VisualRoutines : public RoboComp::Application
{
public:
	VisualRoutines (QString prfx) { prefix = prfx.toStdString(); }
private:
	void initialize();
	std::string prefix;
	MapPrx mprx;
...
void ::VisualRoutines::initialize()
{
...
int ::VisualRoutines::run(int argc, char* argv[])
{
#ifdef USE_QTGUI
